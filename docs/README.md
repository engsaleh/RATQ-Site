# رتق: خارطة الطريق للمطورين مع أهم تقنيات وتطبيقات القرآن الكريم
...
- **[التطبيقات المتاحة](./Available%20Apps.md)**  قائمة مختارة منتقاة بتطبيقات القرآن المفيدة والملهمة.
-  **[التقنيات](./Technologies.md)**  نظرة عامة على الأدوات والتقنيات المستخدمة في بناء تطبيقات القرآن.

>
> **ملاحظة1:** هذا المستند قيد التحديث المستمر، فلا تتردد في المساهمة إذا كنت تعرف مصادر غير مذكورة أو لاحظت أي أخطاء فيه.
>
>> **ملاحظة2:** هذا التجميع جهد من فريق إتقان ولم يؤخذ من أي مكان آخر، إذا كنت تعرف أي جهود مماثلة، يرجى إعلامنا.
